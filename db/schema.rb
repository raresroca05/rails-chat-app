...
ActiveRecord::Schema[8.0].define(version: 2025_07_30_072804) do
  ...
  create_table "room_memberships", force: :cascade do |t|
    ...
    t.index ["user_id", "chat_room_id"], name: "index_room_memberships_on_user_id_and_chat_room_id", unique: true
